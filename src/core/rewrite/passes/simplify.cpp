...
namespace latex_solver {
    ...
    ExprPtr Simplifier::simplify(const Expr &expr) {
        return simplify_expr(expr);
    }

    ExprPtr Simplifier::simplify_expr(const Expr &expr) {
    ...
    ExprPtr Simplifier::simplify_binary(const BinaryOp &bin) {
    ...
    ExprPtr Simplifier::simplify_function(const Function &func) {
